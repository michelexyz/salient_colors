...
glmm_model1 <- glmer(correct_response ~ expected_side + (1 | subject_id) + (1 | scene_id),
                    data = data, 
                    family = binomial)
...
glmm_model2 <- glmer(correct_response ~ expected_side * gender + (1 | subject_id) + (1 | scene_id),
                    data = data, 
                    family = binomial)
...
```{r}
data$trial_no_scaled = data$trial_no / 80.0
